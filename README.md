...
A Linux-based BBS door that aggregates 3 popular door servers into a single menu system that runs as an external door. It has lightbar driven menus, customizable art and a built-in statistic screen. And ANSI capable terminal program (like SyncTerm, Maigterm or Netrunner), at 80x25 screen size, is required.
